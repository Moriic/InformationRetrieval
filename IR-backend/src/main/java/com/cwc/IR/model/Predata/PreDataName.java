...
@Data
@Slf4j
public class PreDataName implements PreData {
    private static PreDataName instance = new PreDataName();
...
//    Map<String, Map<Integer, ArrayList<Integer>>> positionalIndex = new TreeMap<>();
    ...
    private void Init() {
        ...
        for (int i = 0; i < allTeachers.size(); i++) {
            String teacherName = allTeachers.get(i).getTitle();
            ...
            // 生成 positionIndex
            List<String> tokens = segmenter.sentenceProcess(teacherName);
            ...
            // 计算相似度相关
            tokens = MyTokenizerUtil.tokenize(teacherName);
    ...
    public static PreDataName newInstance() {
        return instance;
    }
}
